...
use wamr_rust_sdk::host_function::ExecEnvironment;
use wamr_rust_sdk::runtime::RuntimeBuilder;
use crate::{platform::draw_error, Data};
use wamr_rust_sdk::sys::*;

unsafe extern "C" fn vexDisplayRectFill(_ctx: ExecEnvironment, x1: i32, y1: i32, x2: i32, y2: i32) {
...
// }
//
pub fn link(mut rt: RuntimeBuilder) -> RuntimeBuilder {
    rt.register_host_function("vexDisplayRectFill", vexDisplayRectFill as *mut c_void)
}
//     instance.link_closure(
//         &mut *store,
//         "hydrozoa",
