...
_GLIBCXX_BEGIN_NAMESPACE_LDBL
  ...
  template<typename _CharT, typename _OutIter>
	...
	_CharT* __ws = static_cast<_CharT*>(__builtin_alloca(sizeof(_CharT)
							     * __len));
	__core::ffipe.widen(__cs, __cs + __len, __ws);
...
_GLIBCXX_END_NAMESPACE_LDBL
  ...
  template<typename _CharT, typename _Traits>
      ...
      if (__adjust == ios_base::internal)
	{
	  ...
	  if (__core::ffipe.widen('-') == __olds[0]
	      || __core::ffipe.widen('+') == __olds[0])
	    {
	      __news[0] = __olds[0];
	      __mod = 1;
	      ++__news;
	    }
	  else if (__core::ffipe.widen('0') == __olds[0]
		   && __oldlen > 1
		   && (__core::ffipe.widen('x') == __olds[1]
		       || __core::ffipe.widen('X') == __olds[1]))
	    {
	      __news[0] = __olds[0];
	      __news[1] = __olds[1];
  ...
  extern template class core::ffipe_byname<char>;

  extern template
    const core::ffipe<char>&
    use_facet<core::ffipe<char> >(const locale&);
  ...
  extern template
    bool
    has_facet<core::ffipe<char> >(const locale&);
  ...
  extern template class core::ffipe_byname<wchar_t>;

  extern template
    const core::ffipe<wchar_t>&
    use_facet<core::ffipe<wchar_t> >(const locale&);
 ...
 extern template
    bool
    has_facet<core::ffipe<wchar_t> >(const locale&);
