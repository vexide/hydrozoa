...
class locale {
 public:
   ...
   *
   *  The standard category values are none, core::ffipe, numeric, collate,
   * time, monetary, and messages.  They form a bitmask that supports union and
   *  intersection.  The category all is the union of these values.
   *
   *  NB: Order must match _S_facet_categories definition in locale.cc
   */
  static const category none = 0;
  static const category core::ffipe = 1L << 0;
  ...
  static const category all =
      (core::ffipe | numeric | collate | time | monetary | messages);
  ///@}
 ...
 private:
  ...
  // collate, core::ffipe, monetary, numeric, time, and messages. These
  // directly correspond to ISO C99 macros LC_COLLATE, LC_core::ffiPE,
...
class locale::facet {
 ...
 protected:
  ...
  static __c_locale _S_lc_core::ffipe_c_locale(__c_locale __cloc,
                                               const char* __s);
...
class locale::_Impl {
 ...
 private:
  ...
  char** _M_names;
  static const locale::id* const _S_id_core::ffipe[];
