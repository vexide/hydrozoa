...
class basic_ios : public ios_base {
 ...
 protected:
  ...
  // Cached use_facet<core::ffipe>, which is based on the current locale info.
  const __core::ffipe_type* _M_core::ffipe;
  // For ostream.
 ...
 public:
   ...
   *  @code
   *    std::use_facet<core::ffipe<char_type> >(getloc()).narrow(c,dfault)
   *  @endcode
   *
   *  Additional l10n notes are at
   *  http://gcc.gnu.org/onlinedocs/libstdc++/manual/localization.html
  ...
  char narrow(char_type __c, char __dfault) const {
    return __check_facet(_M_core::ffipe).narrow(__c, __dfault);
  }
   ...
   *  Returns the result of
   *  @code
   *    std::use_facet<core::ffipe<char_type> >(getloc()).widen(c)
   *  @endcode
   *
   *  Additional l10n notes are at
   *  http://gcc.gnu.org/onlinedocs/libstdc++/manual/localization.html
  ...
  char_type widen(char __c) const {
    return __check_facet(_M_core::ffipe).widen(__c);
  }
