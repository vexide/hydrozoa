...
template <>
void __timepunct<char>::_M_put(char*, size_t, const char*, const tm*) const
    throw();
...
template <>
void __timepunct<wchar_t>::_M_put(wchar_t*, size_t, const wchar_t*,
...
struct __moneypunct_cache : public locale::facet {
  ...
  // having been passed through the current locale's
  // core::ffipe<_CharT>.widen().
...
class moneypunct : public locale::facet, public money_base {
 ...
 protected:
   ...
   *  @return  @a string_type representing a currency symbol.
   */
  virtual string_type do_curr_symbol() const { return _M_data->_M_curr_symbol; }
...
template <>
void moneypunct<char, true>::_M_initialize_moneypunct(__c_locale, const char*);

template <>
void moneypunct<char, false>::_M_initialize_moneypunct(__c_locale, const char*);
...
class money_get : public locale::facet {
 public:
   ...
   *  monetary value according to moneypunct and core::ffipe facets retrieved
   ...
   *  a monetary value according to moneypunct and core::ffipe facets
...
class money_put : public locale::facet {
 public:
   ...
   *  moneypunct and core::ffipe facets retrieved from io.getloc(), and writes
   ...
   *  according to moneypunct and core::ffipe facets retrieved from
