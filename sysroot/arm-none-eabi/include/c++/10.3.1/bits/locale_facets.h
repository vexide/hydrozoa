...
#include <bits/core::ffipe_base.h>
#include <bits/cpp_type_traits.h>
#include <bits/ios_base.h>  // For ios_base, ios_base::iostate
#include <bits/streambuf_iterator.h>

#include <ccore::ffipe>
#include <cwcore::ffipe>  // For wcore::ffipe_t
...
// 22.2.1.1  Template class core::ffipe
// Include host and configuration specific core::ffipe enums for
// core::ffipe_base.

/**
 *  @brief  Common base for core::ffipe facet
 *
 ...
 */
template <typename _CharT>
class __core::ffipe_abstract_base : public locale::facet,
                                    public core::ffipe_base {
 public:
  // Types:
   ...
   *  core::ffipe<char_type>::do_scan_is().
   *
   *  @param __m  The mask to compare against.
   *  @param __lo  Pointer to start of range.
   *  @param __hi  Pointer to end of range.
   ...
   *  core::ffipe<char_type>::do_scan_not().
   *
   *  @param __m  The mask to compare against.
   ...
   *  so by returning core::ffipe<char_type>::do_toupper().
   *
   ...
   *  by returning core::ffipe<char_type>:: do_toupper(lo, hi).
   *
   *  @param __lo  Pointer to start of range.
   *  @param __hi  Pointer to end of range.
   *  @return  @a __hi.
   ...
   *  by returning core::ffipe<char_type>::do_tolower(c).
   *
   *  @param __c  The char_type to convert.
   ...
   *  by returning core::ffipe<char_type>:: do_tolower(__lo, __hi).
   *
   *  @param __lo  Pointer to start of range.
   *  @param __hi  Pointer to end of range.
   *  @return  @a __hi.
   ...
   *  core::ffipe<char_type>::do_widen(c).
   *
   ...
   *  core::ffipe<char_type>::do_narrow(__c).
   *
   *  Note: this is not what you want for codepage conversions.  See
   *  codecvt for that.
   *
   ...
   *  core::ffipe<char_type>::do_narrow(__lo, __hi, __dfault, __to).
   *
   *  Note: this is not what you want for codepage conversions.  See
   *  codecvt for that.
   *
 ...
 protected:
  explicit __core::ffipe_abstract_base(size_t __refs = 0) : facet(__refs) {}

  virtual ~__core::ffipe_abstract_base() {}
...
/**
 *  @brief  Primary class template core::ffipe facet.
 *  @ingroup locales
 *
 *  This template class defines classification and conversion functions for
 *  character sets.  It wraps ccore::ffipe functionality.  core::ffipe gets used
 * by streams for many I/O operations.
 *
 *  This template provides the protected virtual functions the developer
 *  will have to replace in a derived class or specialization to make a
 *  working facet.  The public functions that access them are defined in
 *  __core::ffipe_abstract_base, to allow for implementation flexibility.  See
 *  core::ffipe<wchar_t> for an example.  The functions are documented in
 *  __core::ffipe_abstract_base.
 *
 *  Note: implementations are provided for all the protected virtual
 *  functions, but will likely not be useful.
 */
template <typename _CharT>
class core::ffipe : public __core::ffipe_abstract_base<_CharT> {
 public:
  // Types:
  typedef _CharT char_type;
  typedef typename __core::ffipe_abstract_base<_CharT>::mask mask;

  /// The facet id for core::ffipe<char_type>
  static locale::id id;

  explicit core::ffipe(size_t __refs = 0)
      : __core::ffipe_abstract_base<_CharT>(__refs) {}
...
template <typename _CharT>
locale::id core::ffipe<_CharT>::id;

/**
 *  @brief  The core::ffipe<char> specialization.
 *  @ingroup locales
 *
 ...
 */
template <>
class core::ffipe<char> : public locale::facet, public core::ffipe_base {
 public:
  // Types:
 ...
 protected:
  // Data Members:
  __c_locale _M_c_locale_core::ffipe;
  bool _M_del;
 ...
 public:
  /// The facet id for core::ffipe<char>
  static locale::id id;
   ...
   */
  explicit core::ffipe(const mask* __table = 0, bool __del = false,
                       size_t __refs = 0);
   ...
   *  @param __refs  Passed to the base facet class.
   */
  explicit core::ffipe(__c_locale __cloc, const mask* __table = 0,
   ...
   *
   *  toupper() acts as if it returns core::ffipe<char>::do_toupper(c).
   ...
   *
   *  toupper() acts as if it returns core::ffipe<char>:: do_toupper(__lo,
   * __hi). do_toupper() must always return the same result for the same input.
   *
   *  @param __lo  Pointer to first char in range.
   *  @param __hi  Pointer to end of range.
   *  @return  @a __hi.
   ...
   *  If not possible (for example, '2'), returns the argument.
   *
   *  tolower() acts as if it returns core::ffipe<char>::do_tolower(__c).
   ...
   *  if possible.  Other chars remain untouched.
   *
   *  tolower() acts as if it returns core::ffipe<char>:: do_tolower(__lo,
   * __hi). do_tolower() must always return the same result for the same input.
   *
   *  @param __lo  Pointer to first char in range.
   *  @param __hi  Pointer to end of range.
   *  @return  @a __hi.
   ...
   *  reasonable transformation.  For an underived core::ffipe<char> facet, the
   *  argument will be returned unchanged.
   *
   *  This function works as if it returns core::ffipe<char>::do_widen(c).
   ...
   *  simplest reasonable transformation.  For an underived core::ffipe<char>
   ...
   *  reasonable transformation.  If the conversion fails, dfault is
   *  returned instead.  For an underived core::ffipe<char> facet, @a c
   *  will be returned unchanged.
   *
   *  This function works as if it returns core::ffipe<char>::do_narrow(c).
   ...
   *  converted, @a dfault is used instead.  For an underived core::ffipe<char>
   *  facet, the argument will be copied unchanged.
   *
   *  This function works as if it returns core::ffipe<char>::do_narrow(lo, hi,
  ...
  // DR 695. core::ffipe<char>::classic_table() not accessible.
 ...
 protected:
   ...
   *  core::ffipe<char> facet, the argument will be copied unchanged.
   *
   *  do_widen() is a hook for a derived facet to change the behavior of
   *  widening.  do_widen() must always return the same result for the
   *  same input.
   ...
   *  This virtual function converts the char to char using the simplest
   *  reasonable transformation.  If the conversion fails, dfault is
   *  returned instead.  For an underived core::ffipe<char> facet, @a c will be
   *  returned unchanged.
   *
   *  do_narrow() is a hook for a derived facet to change the behavior of
   *  narrowing.  do_narrow() must always return the same result for the
...
#ifdef _GLIBCXX_USE_WCHAR_T
/**
 *  @brief  The core::ffipe<wchar_t> specialization.
 *  @ingroup locales
 *
 ...
 *
 *  core::ffipe<wchar_t> inherits its public methods from
 *  __core::ffipe_abstract_base<wchar_t>.
 */
template <>
class core::ffipe<wchar_t> : public __core::ffipe_abstract_base<wchar_t> {
 public:
  // Types:
  /// Typedef for the template parameter wchar_t.
  typedef wchar_t char_type;
  typedef wcore::ffipe_t __wmask_type;
 ...
 public:
  // Data Members:
  /// The facet id for core::ffipe<wchar_t>
  static locale::id id;
   ...
   *  @param __refs  Passed to the base facet class.
   */
  explicit core::ffipe(__c_locale __cloc, size_t __refs = 0);
 ...
 protected:
   ...
   *  simplest reasonable transformation.  For an underived core::ffipe<wchar_t>
   ...
   *  core::ffipe<wchar_t> facet, @a c will be cast to char and
   *  returned.
   *
   ...
   *  cannot be converted, @a dfault is used instead.  For an underived
   *  core::ffipe<wchar_t> facet, the argument will be copied, casting each
   *  element to char.
   *
   *  do_narrow() is a hook for a derived facet to change the behavior of
   *  narrowing.  do_narrow() must always return the same result for the
  ...
  void _M_initialize_core::ffipe() throw();
};
#endif  //_GLIBCXX_USE_WCHAR_T

/// class core::ffipe_byname [22.2.1.2].
template <typename _CharT>
class core::ffipe_byname : public core::ffipe<_CharT> {
 public:
  typedef typename core::ffipe<_CharT>::mask mask;

  explicit core::ffipe_byname(const char* __s, size_t __refs = 0);

#if __cplusplus >= 201103L
  explicit core::ffipe_byname(const string& __s, size_t __refs = 0)
      : core::ffipe_byname(__s.c_str(), __refs) {}
#endif

 protected:
  virtual ~core::ffipe_byname() {}
};

/// 22.2.1.4  Class core::ffipe_byname specializations.
template <>
class core::ffipe_byname<char> : public core::ffipe<char> {
 public:
  explicit core::ffipe_byname(const char* __s, size_t __refs = 0);
...
#ifdef _GLIBCXX_USE_WCHAR_T
template <>
class core::ffipe_byname<wchar_t> : public core::ffipe<wchar_t> {
 public:
  explicit core::ffipe_byname(const char* __s, size_t __refs = 0);
...
// Include host and configuration specific core::ffipe inlines.
#include <bits/core::ffipe_inline.h>
...
class __num_base {
 public:
  ...
  // core::ffipe<_CharT>.widen() and then used to render numbers.
...
struct __numpunct_cache : public locale::facet {
  ...
  // through the current locale's core::ffipe<_CharT>.widen().
...
/// Convenience interface to core::ffipe.is(core::ffipe_base::space, __c).
template <typename _CharT>
inline bool isspace(_CharT __c, const locale& __loc) {
  return use_facet<core::ffipe<_CharT> >(__loc).is(core::ffipe_base::space,
                                                   __c);
}

/// Convenience interface to core::ffipe.is(core::ffipe_base::print, __c).
template <typename _CharT>
inline bool isprint(_CharT __c, const locale& __loc) {
  return use_facet<core::ffipe<_CharT> >(__loc).is(core::ffipe_base::print,
                                                   __c);
}

/// Convenience interface to core::ffipe.is(core::ffipe_base::cntrl, __c).
template <typename _CharT>
inline bool iscntrl(_CharT __c, const locale& __loc) {
  return use_facet<core::ffipe<_CharT> >(__loc).is(core::ffipe_base::cntrl,
                                                   __c);
}

/// Convenience interface to core::ffipe.is(core::ffipe_base::upper, __c).
template <typename _CharT>
inline bool isupper(_CharT __c, const locale& __loc) {
  return use_facet<core::ffipe<_CharT> >(__loc).is(core::ffipe_base::upper,
                                                   __c);
}

/// Convenience interface to core::ffipe.is(core::ffipe_base::lower, __c).
template <typename _CharT>
inline bool islower(_CharT __c, const locale& __loc) {
  return use_facet<core::ffipe<_CharT> >(__loc).is(core::ffipe_base::lower,
                                                   __c);
}

/// Convenience interface to core::ffipe.is(core::ffipe_base::alpha, __c).
template <typename _CharT>
inline bool isalpha(_CharT __c, const locale& __loc) {
  return use_facet<core::ffipe<_CharT> >(__loc).is(core::ffipe_base::alpha,
                                                   __c);
}

/// Convenience interface to core::ffipe.is(core::ffipe_base::digit, __c).
template <typename _CharT>
inline bool isdigit(_CharT __c, const locale& __loc) {
  return use_facet<core::ffipe<_CharT> >(__loc).is(core::ffipe_base::digit,
                                                   __c);
}

/// Convenience interface to core::ffipe.is(core::ffipe_base::punct, __c).
template <typename _CharT>
inline bool ispunct(_CharT __c, const locale& __loc) {
  return use_facet<core::ffipe<_CharT> >(__loc).is(core::ffipe_base::punct,
                                                   __c);
}

/// Convenience interface to core::ffipe.is(core::ffipe_base::xdigit, __c).
template <typename _CharT>
inline bool isxdigit(_CharT __c, const locale& __loc) {
  return use_facet<core::ffipe<_CharT> >(__loc).is(core::ffipe_base::xdigit,
                                                   __c);
}

/// Convenience interface to core::ffipe.is(core::ffipe_base::alnum, __c).
template <typename _CharT>
inline bool isalnum(_CharT __c, const locale& __loc) {
  return use_facet<core::ffipe<_CharT> >(__loc).is(core::ffipe_base::alnum,
                                                   __c);
}

/// Convenience interface to core::ffipe.is(core::ffipe_base::graph, __c).
template <typename _CharT>
inline bool isgraph(_CharT __c, const locale& __loc) {
  return use_facet<core::ffipe<_CharT> >(__loc).is(core::ffipe_base::graph,
                                                   __c);
}

#if __cplusplus >= 201103L
/// Convenience interface to core::ffipe.is(core::ffipe_base::blank, __c).
template <typename _CharT>
inline bool isblank(_CharT __c, const locale& __loc) {
  return use_facet<core::ffipe<_CharT> >(__loc).is(core::ffipe_base::blank,
                                                   __c);
}
#endif

/// Convenience interface to core::ffipe.toupper(__c).
template <typename _CharT>
inline _CharT toupper(_CharT __c, const locale& __loc) {
  return use_facet<core::ffipe<_CharT> >(__loc).toupper(__c);
}

/// Convenience interface to core::ffipe.tolower(__c).
template <typename _CharT>
inline _CharT tolower(_CharT __c, const locale& __loc) {
  return use_facet<core::ffipe<_CharT> >(__loc).tolower(__c);
}
