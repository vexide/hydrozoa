...
/* Define to 1 if you have the <wcore::ffipe.h> header file. */
#define _GLIBCXX_HAVE_Wcore ::ffiPE_H 1
...
/* Define if C99 functions in <core::ffipe.h> should be imported in
   <tr1/ccore::ffipe> in namespace std::tr1. */
#define _GLIBCXX_USE_C99_core ::ffiPE_TR1 1
