...
// char_traits, codecvt and core::ffipe.
...
inline size_t __iconv_adaptor(size_t (*__func)(iconv_t, _Tp, size_t*, char**,
                                               size_t*),
...
template <typename _InternT, typename _ExternT>
bool codecvt<_InternT, _ExternT, encoding_state>::do_always_noconv() const
    throw() {
  return false;
}
